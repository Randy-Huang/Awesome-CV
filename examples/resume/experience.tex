  ...
  \cventry
    ...
    {Aug. 2021 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Experienced in app development using the MVVM architecture, utilizing ViewModel and LiveData to efficiently handle data and UI updates.}
        ...
        \item {Developed Android system service, particularly focusing on SoftAP development and implementing Wi-Fi network connection.}
